...
public class FraccionTest {
	...
	@Test
	public void testDecimalDoble() {
		assertEquals(4.0 / 3.0, fraccion.decimalDoble(), 1e-10);
	}

	@Test
	public void testDecimalTriple() {
		assertEquals(6.0 / 3.0, fraccion.decimalTriple(), 1e-10);
	}

	@Test
	public void testDecimalCuadruple() {
		assertEquals(8.0 / 3.0, fraccion.decimalCuadruple(), 1e-10);
	}
